...
.%tclass% {
	...
	/* for webkit browsers */
	background: -webkit-gradient(linear, left top, left bottom, from(#074d1b), to(#0d0d0d)); 
	/* for firefox 3.6+ */
	background: -moz-linear-gradient(top,  #074d1b,  #0d0d0d); 
	/* for IE */
	background: -ms-linear-gradient(top,  #074d1b, #0d0d0d);
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#074d1b', endColorstr='#0d0d0d'); 

	/* for opera */

	background-image: -o-linear-gradient(-90deg, #074d1b, #0d0d0d);
	/* catch all */
...
.%tclass% .poll-button {
	...
	/* for IE */
	background: -ms-linear-gradient(top,  #074d1b, #0d0d0d);
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#074d1b5', endColorstr='#0d0d0d'); 
	/* for opera */
	background-image: -o-linear-gradient(-90deg, #074d1b, #0d0d0d);
	/* catch all */
	background-color:#074d1b;
